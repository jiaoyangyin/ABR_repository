...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED,
        ...
        self.cooked_bw = [x+y for x in self.all_cooked_bw[self.trace_idx] for y in [0]]
    ...
    def get_video_frame(self, quality, target_buffer, latency_limit):
        ...
        if self.time < self.cdn_arrive_time[quality][
            ...
            return [self.time,  # physical time
                    0,  # duration, this loop duration, means the download time
                    0,  # frame data size
                    0,  # frame time len
                    rebuf,  # rebuf len
