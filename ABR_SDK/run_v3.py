...
def test(user_id):
    ...
    video_trace_prefix = './dataset/video_trace2/' + VIDEO_TRACE + '/new_frame_size_'
    ...
    log_rate = open(
        './reward_' + method + '_' + NETWORK_TRACE + '_bitratevstime_trace' + str(
            net_env.get_trace_id()), 'wb')
    log_rebuf = open(
        './reward_' + method + '_' + NETWORK_TRACE + '_rebufvstime_trace' + str(
            net_env.get_trace_id()), 'wb')
    log_rebuf2 = open(
        './reward_' + method + '_' + NETWORK_TRACE + '_rebufvsgop_trace' + str(
            net_env.get_trace_id()), 'wb')
    log_reward = open(
        './reward_' + method + '_' + NETWORK_TRACE + '_rewardvsgop_trace' + str(
            net_env.get_trace_id()), 'wb')
